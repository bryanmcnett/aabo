...
If you construct the AABH from the object's vertices instead, you can trivially reject more objects than an AABB can, but you will need to do all 6 AABH checks too:
