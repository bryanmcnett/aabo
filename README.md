...
* A k-DOP can not have opposing polyhedra if there exists a hemisphere that contains none of its axes. Axes with empty hemispheres commonly appear in k-DOP literature. Nowhere can we find discussion of how choice of axes affects a k-DOP’s ability to have opposing polyhedra, which is required to avoid reading half of its data most of the time.
