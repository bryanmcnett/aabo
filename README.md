...
In addition to the array of up-pointing triangles, we can have an array of down-pointing triangles, and each pair of up and down triangles defines an axis-aligned bounding hexagon:
