...
In addition to the up-pointing triangle bounding volume, we can have a down-pointing triangle bounding volume, and the intersection defines an axis-aligned bounding hexagon:
