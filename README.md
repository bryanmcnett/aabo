...
This AABH won't trivially reject any more objects than the original AABB, but the AABH will take less time to reject objects, because there are (usually) 3 checks instead of 4 - as long as there are separate arrays for minABC and maxABC. 
